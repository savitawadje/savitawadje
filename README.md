...
I'm a full-stack developer who loves solving real problems with code. Comfortable across the JavaScript ecosystem (React, Node.js), with a growing interest in open source and building things that are simple, fast, and useful.
...
[![My Skills](https://skillicons.dev/icons?i=js,ts,react,nodejs,tailwind,mongodb,mysql,git)](https://skillicons.dev)
